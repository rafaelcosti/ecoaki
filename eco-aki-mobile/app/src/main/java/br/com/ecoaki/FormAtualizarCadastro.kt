...
class FormAtualizarCadastro : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_form_atualizar_cadastro)

        val bt_cadastrarUsuario = findViewById<Button>(R.id.bt_cadastrarUsuario)
        
        bt_cadastrarUsuario.setOnClickListener {
